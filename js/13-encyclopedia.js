...
'use strict';
  ...
  const ENCY_GRADES = [
    ...
    { name: '具象级', entries: ['striker_crimson', 'striker_amber', 'striker_azure', 'striker_white', 'striker_dusk'] },
    { name: '真我级', entries: ['gunship_violet', 'gunship_crimson', 'gunship_amber', 'harbinger', 'weilong', 'hanshuang', 'yu4', 'baoling'] },
  ...
  const ENCY_DATA = {
    ...
    weilong: {
      name: '威龙', type: 'weilong', color: '#ff9a1a', hp: 4567, score: 700,
    ...
    yu4: {
      ...
      desc: '俯视四旋翼防御无人机：介于圆形与正方形之间的<b>超椭圆（方圆形）机体</b>（暖灰渐变），中央为<b>小片淡黄色反应核</b>，一道 <b>“X”形金色条纹</b> 指向四角的风扇圆（中心黑、边缘暖灰渐变）。<b>不攻击</b>：登场 <b>0.5s</b> 后展开<b>金色六边力场</b>，力场内<b>所有敌人受到的非真实伤害降低 30%</b>（<b>高能爆弹为真实伤害</b>，无视力场）。下降速度较常规 3 类炮艇 <b>低 20%</b>，悬停位置与炮艇一致，停留 <b>25s</b> 后离场；碰撞伤害仅为炮艇的 <b>50%</b>。<b>Lv10 前不出场</b>。优先击毁以免其庇护友军。',
    },
    baoling: {
